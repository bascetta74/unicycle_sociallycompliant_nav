function NearNodesIdx=findPointsInConflictRemove(ObsNum,obstacle,nodeList,r,totalNode)
...
for i = 1:pathLength
    ...
    searchRange = r + norm(obstacle(ObsNum).FuturePoint(1:2,i) - obstacle(ObsNum).FuturePoint(1:2,j))/ 2.0;
