function [node,graphTree,Q,QMatrix,orphanNodes,countOrphan,distNeighbMat]=addObstacle(obsNmbr,Q,QMatrix,node,nodeList,graphTree,obstacle,totalNodeNum,orphanNodes,countOrphan,distNeighbMat,param)
